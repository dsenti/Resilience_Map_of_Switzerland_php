...
<script>
  ...
  geo_json_4757a7460976929ab0308bc59cf096c8.bindPopup(
    function(layer) {
      ...
      let value = "<br><popuptext>In 2021 the area which was artificially impermeable was " + get_impermeable(current_tile) + " ha.<br> The total area is " + get_area(current_tile)+ 
      " ha.<br><br><strong>Therefore, " + get_impermeability_percentage(current_tile) +
