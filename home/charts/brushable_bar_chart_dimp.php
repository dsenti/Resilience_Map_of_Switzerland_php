...
<brushable_bar_chart>
  ...
  <div id="title">Percentage of Artificially Impermeable Areas - Districts (in %)</div>
  <div id="chart"></div>
  ...
  <script>
    var data = [],
      ...
      mini_width,
      textScale;
      var colors = ["#c97777","#a00000","#a00000"];
    var min_zoom = 100;
    var max_zoom = 7;

    function unique(){
      
      json_data = <?php include("../../data/data_districts_impermeability.php"); ?>;
      json_data = JSON.parse(json_data);
      json_data = json_data["percentage artificially impermeable"];
      i = 0;
