...
<brushable_bar_chart>
  ...
  <div id="title">Percentage of Artificially Impermeable Areas - Cantons (in %)</div>
  <div id="chart"></div>
  ...
  <script>
    ...
    var colors = ["#e39d9d","#a00000","#a00000"];
    var min_zoom = 10000;
    var max_zoom = 38;
  function unique(){

      json_data = <?php include("../../data/data_cantons_impermeability.php"); ?>;
