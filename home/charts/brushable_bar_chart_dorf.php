...
<brushable_bar_chart>
  ...
  <div id="title">Percentage of Organic Farming - Districts (in %)</div>
  <div id="chart"></div>
  ...
  <script>
    var data = [],
      ...
      mini_width,
      textScale;
      var colors = ["#86b38d","#00570e","#00570e"];
    var min_zoom = 100;
    var max_zoom = 7;

    function unique(){
      
      json_data = <?php include("../../data/data_districts_organic_farming.php"); ?>;
      json_data = JSON.parse(json_data);
      json_data = json_data["percentage biological farmland"];
      i = 0;
