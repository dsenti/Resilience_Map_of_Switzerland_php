...
<brushable_bar_chart>
  ...
  <div id="title">Percentage of Population Active in Agriculture - Cantons (in %)</div>
  <div id="chart"></div>
  ...
  function unique(){
      ...
      json_data = <?php include("../../data/data_cantons_farmers.php"); ?>;
      ...
      for (var key in json_data) {
        ...
        my_object.key = i;
        i++;
        my_object.tile = key.slice(0,key.length);
